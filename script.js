const chapters = [
  {
    ...
    success:
      "Éxito. Rebobinas mentalmente la escena y lo ves: la cinta no se activa por movimiento, ni por cumpleaños, ni por susto barato de los 90. Se activa cuando el hospital cambia de turno, el aire huele a sal y las visitas dejan de ser humanas. El CRT desbloquea la pregunta.",
    failures: [
  ...
  },
  {
    ...
    dc: 14,
    intro:
      "La primera puerta cede y te escupe a una sala de taquillas con olor a metal viejo, colonia de hospital abandonado y algo marino que no pinta nada aquí. Hay tres pulseras de ingreso colgadas en ganchos oxidados: Anna, Isaac y Judit. La de Anna tiene una nota: mantiene al grupo unido aunque el mapa mienta. La de Judit: encontró una llave, no preguntes dónde. La de Isaac tiene dos etiquetas superpuestas: VICTIMA y SOSPECHOSO HABITUAL. Detrás de su nombre hay un símbolo con tentáculos dibujado a boli, lo cual no mejora su defensa. La máquina exige ordenar el registro antes de que las taquillas vuelvan a cerrarse con alguien dentro.",
    success:
    ...
    failures: [
      "Fallo. Abres una taquilla equivocada y cae una montaña de componentes imaginarios sin embolsar, junto a una ficha que pone CULTISTA 3/6. El horror adopta muchas formas, y una de ellas es organizar una campaña a medianoche. Vuelve a tirar.",
