const chapters = [
  {
    ...
    dc: 12,
    intro:
      "La transmisión arranca como una cinta de videoclub mal rebobinada. En pantalla: un pasillo de hospital, luz roja, fecha imposible y tres siluetas retenidas al fondo. Durante un fotograma aparece una palabra que no debería estar en ningún expediente médico: R'lyeh. Anna golpea una puerta con la calma exacta de quien aún no se ha enfadado porque nadie ha ido contra ella. Judit señala una cámara que no debería estar encendida y el sistema avisa: RIESGO DE SEMICOOPERATIVO. Isaac aparece medio segundo antes que los demás, mirando directamente al objetivo, como si hubiera llegado allí antes que el guion. Rafa, por supuesto, ya está evaluando si la ambientación merece un 7 o un 8. El sistema escribe: TURNO CERO. Solo quien distinga cuándo empieza podrá abrir el primer cierre.",
    success:
      "Éxito. Rebobinas mentalmente la escena y lo ves: la cinta no se activa por movimiento, ni por cumpleaños, ni por susto barato de los 90. Se activa cuando el hospital cambia de turno, el aire huele a sal y las visitas dejan de ser humanas. El CRT desbloquea la pregunta. Rafa concede provisionalmente que el uso de cámara antigua está bien, aunque la pista podría estar mejor integrada.",
    failures: [
  ...
  },
  {
    ...
    failures: [
      "Fallo. Abres una taquilla equivocada y cae una montaña de componentes imaginarios sin embolsar, junto a una ficha que pone CULTISTA 3/6. Rafa detecta sobreproducción innecesaria. El horror adopta muchas formas, y una de ellas es organizar una campaña a medianoche. Vuelve a tirar.",
  ...
  },
  {
    ...
    dc: 10,
    intro:
      "El plano del hospital se despliega como un tablero que alguien ha diseñado con odio, mucho tiempo libre y una relación preocupante con la geometría no euclidiana. Pasillos como losetas, habitaciones como encuentros, puertas que prometen atajos y huelen a mala decisión. Anna aparece marcada como VICTIMA EN PELIGRO y debajo: no provocar si la estrategia incluye ir contra ella. Judit aparece junto a una llave que nadie recuerda haber conseguido; el sistema ya no se atreve a llamarlo cooperativo. Isaac parpadea entre ALIADO PROBABLE, SOSPECHOSO POSIBLE y NO DEJAR SOLO CON OBJETOS BRILLANTES. En una esquina del mapa, donde debería haber almacén, aparece escrito: PH'NGLUI. Rafa detecta que el diseño del tablero intenta parecer profundo, cosa que siempre merece inspección. El mapa ofrece una salida rápida si el grupo se separa. Eso, naturalmente, es una trampa.",
    success:
    ...
    failures: [
      "Fallo. El mapa susurra: dividiros, cubrís más terreno. Esa frase ha eliminado más grupos que cualquier monstruo con miniatura grande. Anna interpreta la propuesta como ir contra ella. Mala idea. Respira, mira mal a la pantalla y vuelve a tirar.",
    ...
    report:
      "CIERRE 3 DESBLOQUEADO.\n\nAnna y Judit salen del estado VICTIMA EN PELIGRO. Anna no se ha enfadado del todo: éxito social parcial.\nJudit devuelve la llave al inventario común, aunque el sistema deja una nota: vigilar en próximos cooperativos.\nIsaac permanece bajo observación preventiva, por motivos obvios, fulleros y por otros que el sistema prefiere no explicar.\nRafa concluye que la experiencia tiene buen empaque, aunque ya hablaremos del final.\nEl grupo sigue junto. La puerta final acepta la regla.\nEl culto local queda decepcionado por vuestra buena coordinación.\n\nUn sobre aparece al otro lado del monitor.",
    lock: {
